...
const ContactChat = ({ config }) => {
  ...
  return (
    <section id="contacto" className="border-t border-slate-800 bg-slate-900/60 py-20">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 md:grid-cols-2">
        <div className="space-y-4">
          <h2 className="text-3xl font-semibold text-white">Hablemos de tu próximo proyecto</h2>
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/70 p-4 text-sm text-slate-300">
            <p>
              <span className="font-medium text-slate-200">Correo:</span> {config.contactEmail}
            </p>
            <p className="mt-2">
        ...
        <form
          ...
          className="space-y-4 rounded-2xl border border-slate-800 bg-slate-950/70 p-6 shadow-lg shadow-slate-900/40"
        >
          <div>
